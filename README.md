...
2. Clone this repo to your local machine
    ...
    - Pick a location with a few GB of free space to clone to, as the data for this project may exceed 10GB for a full install
...
#### Demo Only
4. Run <code>proof_of_concept.ipynb</code> to demonstrate the functionality of each model; train and test dataset subsamples are included for this